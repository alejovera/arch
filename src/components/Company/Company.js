...
function Company() {
    return (
        <section className="aboutUs__container">
            <div>
                <h2 className="aboutUs__large-title">Welcome</h2>
            </div>
            <div className="aboutUs__content">
                <h3 className="aboutUs__title">Welcome to <br /> Arch Studio</h3>
                <p className="aboutUs__info">
                    Welcome to Arch Studio We have a unique network and skillset to help bring your projects to life. Our small team of highly skilled individuals combined with our large network put us in a strong position to deliver exceptional results. <br></br>
